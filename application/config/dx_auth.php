...
$config['DX_website_name'] = 'FreeMyTime';
$config['DX_webmaster_email'] = 'contact@freemytime.ro';
...
$config['DX_captcha_path'] = '.application/captcha/';
