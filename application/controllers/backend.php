...
class Backend extends CI_Controller {
    ...
    function users() {
        ...
        // Load view
        $data['view_name'] = $this->dx_auth->backend / users;
    ...
    function unactivated_users() {
        ...
        // Load view
        $data['view_name'] = $this->dx_auth->backend / unactivated_users;
    ...
    function roles() {
        ...
        // Load view
        $data['view_name'] = $this->dx_auth->backend / roles;
        $this->load->view('template', $data);
    }
    ...
    function uri_permissions() {
        ...
        // Load view
        $data['view_name'] = $this->dx_auth->backend / uri_permissions;
        $this->load->view('template', $data);
    }
    ...
    function custom_permissions() {
        ...
        // Load view
        $data['view_name'] = $this->dx_auth->backend / custom_permissions;
